...
public class ReplacedEntityRenderer <T extends IAnimatable> extends EntityRenderer implements IGeoRenderer {
    ...
    private static final Map<Class<? extends IAnimatable>, ReplacedEntityRenderer> renderers = new ConcurrentHashMap<>();

    static {
        AnimationController.addModelFetcher((IAnimatable object) -> {
            ReplacedEntityRenderer renderer = renderers.get(object.getClass());
            return renderer == null ? null : renderer.getGeoModelProvider();
        });
    }

    public ReplacedEntityRenderer(EntityRendererProvider.Context renderManager,
    ...
    public static ReplacedEntityRenderer getRenderer(Class<? extends IAnimatable> item) {
